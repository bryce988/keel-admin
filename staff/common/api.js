 ...
 * 忘了改的话角标会跑到通讯录上，而那是个纯浏览页面，用户完全不知道那个红点在说什么。
 *
 * 2026-09-22 起只剩「消息」一个 tab 有角标：未读公告计入它的总数（common/chatBadge.js），
 * 工作台 tab 不再单独标公告，否则同一条公告在两个 tab 上各算一次。
 */
const TAB_CHAT = 0
...
/** 「消息」tab 的角标：聊天未读 + 未读公告，数字由 common/chatBadge.js 从服务端汇总取 */
