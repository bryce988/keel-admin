...
const columns: ProColumn<PostRow>[] = [
  { prop: 'name', label: '岗位名称', minWidth: 150, align: 'left' },
  { prop: 'code', label: '岗位编码', minWidth: 150, align: 'left' },
  { prop: 'dept_name', label: '所属部门', minWidth: 130, align: 'left' },
  { prop: 'sort', label: '排序', width: 100, align: 'center', sortable: true },
  { prop: 'status', label: '状态', width: 90, align: 'center', dict: 'enable_status' },
  { prop: 'remark', label: '备注', minWidth: 180, align: 'left', hidden: true },
  { prop: 'created_at', label: '创建时间', minWidth: 190, align: 'left', sortable: true, hidden: true },
